...
const activeProjects = ref([
  { id: 1, name: 'ERP 시스템 고도화', client: 'ABC 기업', status: '개발', progress: 65, startDate: '2024-01-15', endDate: '2024-04-30', value: 850000000 },
  { id: 2, name: '모바일 앱 개발', client: 'XYZ 회사', status: '테스트', progress: 85, startDate: '2024-02-01', endDate: '2024-03-15', value: 420000000 },
  { id: 3, name: 'AI 솔루션 구축', client: 'KLM 그룹', status: '개발', progress: 45, startDate: '2024-02-15', endDate: '2024-06-30', value: 680000000 },
  { id: 4, name: '클라우드 마이그레이션', client: 'DEF 코퍼레이션', status: '기획', progress: 25, startDate: '2024-03-01', endDate: '2024-07-15', value: 950000000 },
  { id: 5, name: 'IoT 플랫폼 구축', client: 'GHI 엔터프라이즈', status: '배포', progress: 95, startDate: '2024-01-01', endDate: '2024-03-31', value: 720000000 }
])
